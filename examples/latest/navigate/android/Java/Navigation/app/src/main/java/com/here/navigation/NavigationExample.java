...
public class NavigationExample {
    ...
    private void prefetchMapData(GeoCoordinates currentGeoCoordinates) {
        ...
        // Note that prefetchAroundRouteOnIntervals starts 1 km before reaching the end of the current corridor of 10 km (see below). Hence, for the first part of the route it 
        // is recommended to use the PolygonPrefetcher to cover the start of the route.
