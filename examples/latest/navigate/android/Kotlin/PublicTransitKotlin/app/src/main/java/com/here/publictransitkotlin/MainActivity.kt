...
import com.here.publictransitkotlin.ui.theme.PublicTransitTheme
...
class MainActivity : ComponentActivity() {
    ...
    private var publicTransitExample: PublicTransportRoutingExample? = null
    ...
    fun ButtonRows() {
        Column(
            ...
            Row(
                ...
                CustomButton(onClick = { publicTransitExample?.addTransitRoute() },
                    text = "ADD TRANSIT ROUTE"
                )
                Spacer(modifier = Modifier.width(16.dp))
                CustomButton(onClick = { publicTransitExample?.clearMap() },
                    text = "CLEAR MAP"
                )
            }
        }
    ...
    private fun loadMapScene() {
        ...
        mapViewNonNull.mapScene.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                ...
                publicTransitExample = PublicTransportRoutingExample(this@MainActivity, mapViewNonNull)
            } else {
