...
import com.here.routinghybridkotlin.ui.theme.RoutingHybridTheme
...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var routingExample: RoutingHybridExample
    ...
    fun ButtonRows() {
        Column(
            ...
            Row(
                ...
                CustomButton(onClick = { routingExample.addWaypoints() },
                    text = "Add Waypoints"
                )
                Spacer(modifier = Modifier.width(4.dp))
            ...
            Row(
                ...
                Spacer(modifier = Modifier.width(4.dp))
                CustomButton(onClick = { routingExample.onSwitchOnlineButtonClicked() },
                    text = "Switch Online"
                )
                Spacer(modifier = Modifier.width(4.dp))
                CustomButton(onClick = { routingExample.onSwitchOfflineButtonClicked() },
                    text = "Switch offline"
                )
            }
        }
    ...
    private fun loadMapScene() {
        ...
        mapViewNonNull.mapScene.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                ...
                val mapFeatures = mutableMapOf<String, String>()
                ...
                routingExample = RoutingHybridExample(this@MainActivity, mapViewNonNull)
            } else {
