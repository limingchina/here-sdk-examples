...
import com.here.searchhybridkotlin.ui.theme.SearchHybridTheme
...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var w3wSearchExample: W3WSearchExample
    ...
    fun ButtonRows() {
        Column(
            ...
            Row(
                ...
                CustomButton(onClick = { searchExample.onSearchButtonClicked() },
                    text = "SEARCH  "
                )
            ...
            Row(
                ...
                CustomButton(onClick = { w3wSearchExample.onW3WSearchButtonClicked() },
                    text = "W3W SEARCH"
                )
                Spacer(modifier = Modifier.width(16.dp))
                CustomButton(onClick = { w3wSearchExample.onW3WGeocodeButtonClicked() },
                    text = "W3W GEOCODING"
                )
            }
            Row(
                ...
                CustomButton(onClick = { searchExample.onSwitchOnlineButtonClicked() },
                    text = "SWITCH ONLINE"
                )
                Spacer(modifier = Modifier.width(16.dp))
                CustomButton(onClick = { searchExample.onSwitchOfflineButtonClicked()},
                    text = "SWITCH OFFLINE"
                )
            }
        }
    ...
    private fun loadMapScene() {
        ...
        mapViewNonNull.mapScene.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                ...
                w3wSearchExample = W3WSearchExample(this@MainActivity, mapView!!)
            } else {
