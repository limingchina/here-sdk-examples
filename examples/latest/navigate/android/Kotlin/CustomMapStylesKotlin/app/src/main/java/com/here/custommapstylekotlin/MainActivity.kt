...
import com.here.custommapstyleskotlin.ui.theme.CustomMapStylesTheme
...
class MainActivity : ComponentActivity() {
    ...
    private var customMapStylesExample: CustomMapStylesExample? = null
    ...
    fun ButtonRows() {
        Column(
            ...
            Row(
                ...
                CustomButton(onClick = { customMapStylesExample?.loadButtonClicked() },
                    text = "Load"
                )
                Spacer(modifier = Modifier.width(16.dp))
                CustomButton(onClick = { customMapStylesExample?.unloadButtonClicked() },
                    text = "Unload"
                )
            }
        }
    ...
    private fun loadMapScene() {
        ...
        mapViewNonNull.mapScene.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                customMapStylesExample = CustomMapStylesExample(this@MainActivity, mapViewNonNull)
                customMapStylesExample?.onMapSceneLoaded()
            } else {
