...
import com.here.searchkotlin.ui.theme.SearchTheme
...
import com.here.searchkotlin.SearchExample
    ...
    private fun loadMapScene() {
        ...
        mapViewNonNull.mapScene.loadScene(MapScheme.NORMAL_DAY) { mapError ->
            if (mapError == null) {
                ...
                searchExample = SearchExample(this@MainActivity, mapViewNonNull)
            } else {
